...
//		printf("WS Writeable\n");
                ...
                //m = lws_write(wsi, transmit_buffer + LWS_PRE, 513, LWS_WRITE_BINARY);
                m = lws_write(wsi, transmit_buffer + LWS_PRE, 544, LWS_WRITE_BINARY);
             //   if (m < 544) lwsl_err("WS Error %d  writing to ws\n",m);
		break;
